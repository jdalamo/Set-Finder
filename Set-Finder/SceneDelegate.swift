...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
   ...
   func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
      ...
      let skipWelcomeKeyPresent = UserDefaults.standard.object(forKey: SKIP_WELCOME_KEY) != nil
      if (!skipWelcomeKeyPresent) {
         // First time running app--set default to false
      ...
      if (skipWelcome) {
         rootViewController = mainStoryboard.instantiateViewController(withIdentifier: "main") as UIViewController
      } else {
         rootViewController = mainStoryboard.instantiateViewController(withIdentifier: "welcome") as UIViewController
      }
